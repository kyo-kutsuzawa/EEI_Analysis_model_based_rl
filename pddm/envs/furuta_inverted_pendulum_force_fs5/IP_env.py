...
class InvertedPendulumEnv_Fs5(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,file_path=os.path.join(GYM_ASSET_PATH,"default_ip.xml"),max_step=1000):
        ...
        mujoco_env.MujocoEnv.__init__(self, os.path.join(file_path), 5)
...
class InvertedPendulumEnv1_Fs5(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,file_path=os.path.join(GYM_ASSET_PATH,"default_ip.xml"),max_step=1000):
        self.time = 0
        self.num_step =0
...
class InvertedPendulumEnv2_Fs5(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,file_path=os.path.join(GYM_ASSET_PATH,"default_ip.xml"),max_step=1000):
        self.time = 0
        self.num_step =0
        self.max_step=max_step #maximum number of time steps for one episode
...
class InvertedPendulumEnv3_Fs5(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,file_path=os.path.join(GYM_ASSET_PATH,"default_ip.xml"),max_step=1000):
        self.time = 0
        self.num_step =0
        self.max_step=max_step #maximum number of time steps for one episode
