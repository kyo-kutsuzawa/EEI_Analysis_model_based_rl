...
def bootstrap_ab(test, ctrl, stat_func, compare_func, test_denominator=None,
    ...
    if return_distribution:
        ...
        test_ctrl_val = compare_func(test_val * scale_test_by, ctrl_val) #control func is substruction
        condidence_interval =_get_confidence_interval(test_ctrl_dist, test_ctrl_val, alpha,
                                 is_pivotal)
        return condidence_interval
