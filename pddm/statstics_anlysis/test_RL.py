...
save_dir =args.save_dir+"/{}_training_data/".format(time.strftime("%Y-%m-%d"))
...
if args.data_type=="rewards":
    ...
    load_data1=np.load(args.job_path1 +"/rollouts_ERPerIter.npy")
    load_data2=np.load(args.job_path2 +"/rollouts_ERPerIter.npy")
    load_data3 = np.load(args.job_path3 + "/rollouts_ERPerIter.npy")
...
if args.data_type=="rewards":
    ...
    plt.savefig(save_dir + "/learning_{}_{}.png".format(args.data_type,args.save_num))
    #plt.show()
