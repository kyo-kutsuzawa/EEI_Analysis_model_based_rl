...
class PID:
    def __init__(self, P=5, I=0.1, D=1.5,delta_time=0.04,target_pos=0):
        self.Kp = P
        self.Ki = I
        self.Kd = D
    ...
    def update(self, feedback_value):
        ...
        return - self.output,feedback_value,previouserror, self.PTerm,self.DTerm,error,self.delta_time,delta_error
